...
To rather see service defintion use: <comment>debug:container ezpublish.cache_pool</comment>
...
EOM
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($input->getOption('oneline')) {
            $output->write(get_class($this->getContainer()->get($service)));

            return;
        }

        $output->writeln("<comment>Class name:</> " . get_class($this->getContainer()->get($service)));
    }
}
